...
def negative_assert_symbol(first_name):
    ...
    #Comprueba si el código recibido es 400
    assert user_response.status_code == 400
    # Comprueba si el atributo "code" en el cuerpo de respuesta es 400.
    assert user_response.json()["code"] == 400
    #Comprueba que se devuelve el mensaje de error incorrecto
...
# №1 El parámetro "firstName" contiene dos caracteres
# Resultado esperado: El código de respuesta y el estado: 201 Created; El parámetro "authToken" contiene un token generado recientemente; La tabla "Users" contiene valores pasados
def test_create_user_2_letter_in_first_name_get_success_response():
    positive_assert("Aa")


# №2 El parámetro "firstName" contiene quince caracteres
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Abcdefghijklmno")


# №3 El parámetro "firstName" contiene solo un caracter
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")


# №4 El parámetro "firstName" contiene dieciseis caracteres
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Abcdefghijklmnop")


# №5 El parámetro "firstName" contiene dieciseis caracteres
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Luisa Perez")


# №6 El parámetro "firstName" contiene caracteres especiales
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")


# №7 El parámetro "firstName" contiene un string de números
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")


# №8 La solicitud no contiene el parámetro "firstName"
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
...
# №9 El parámetro "firstName" contiene un string vacío
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request; {"code": 400, "message": El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"}
...
# №10 El tipo del parámetro "firstName" es un número
# Resultado esperado: El código de respuesta y el estado: 400 Bad Request
